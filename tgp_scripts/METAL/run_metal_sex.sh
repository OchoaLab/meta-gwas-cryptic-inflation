...
sed -e "s|INPUT_PLACEHOLDER_1.txt|$1|g" \
    ...
    -e "s|OUTPUT_PLACEHOLDER|$3_${SLURM_ARRAY_TASK_ID}|g" meta_sex_temp.txt > meta_sex_${SLURM_ARRAY_TASK_ID}.txt

# Run METAL with the modified script
/datacommons/ochoalab/metal/metal meta_sex_${SLURM_ARRAY_TASK_ID}.txt