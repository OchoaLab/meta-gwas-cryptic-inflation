...
GMMATmodelFile = paste0(dir, trait, '_quant_trait_LOCO.rda') 
varianceRatioFile = paste0(dir, trait, "_quant_trait_LOCO.varianceRatio.txt") 
SAIGEOutputFile = paste0(dir, "saige_output_", trait, "_loco_chr", chrom, ".txt") 
