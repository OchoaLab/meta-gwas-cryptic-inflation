...
if(loco == 1){
  ...
  print('LOCO == FALSE')
  GMMATmodelFile = paste0(dir, '/simtrait_quant_simtrait.rda') 
  varianceRatioFile = paste0(dir, "/simtrait_quant_simtrait.varianceRatio.txt") 
  SAIGEOutputFile = paste0(dir, "/saige_output_simtrait.txt") 
  print(GMMATmodelFile)
  print(varianceRatioFile)
  print(SAIGEOutputFile)
