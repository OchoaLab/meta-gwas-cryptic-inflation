...
- `samplesize_eval_metric.R`, `samplesize_subset_covar.R`, `samplesize_subset_plink.q`, `samplesize_subset_plink.R`, `samplesize_write_covar.R`
Perform joint quantitative trait GWAS and sex-stratified meta-analysis using existing SAIGE and METAL scripts. 
We further compared cdf of ___ for sim4 with founder of 3000 vs subsetting to 3000: `./figures/kinship_comparison.R`; eval figure: `./figures/samplesize_plot_eval.R`
