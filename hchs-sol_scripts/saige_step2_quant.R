...
GMMATmodelFile = paste0(dir, trait, '_quant_trait.rda') 
varianceRatioFile = paste0(dir, trait, "_quant_trait.varianceRatio.txt") 
SAIGEOutputFile = paste0(dir, "saige_output_", trait, "_trait.txt") 
