...
#SBATCH --job-name=sim1_saige
#SBATCH --output=saige_sim1_%a.out
#SBATCH --array=1-10
#SBATCH --mem=220G
...
time Rscript saige_step1.R -s sim1 -a all -f 1G_3000n_100causal_500000m -n $input_value
time Rscript saige_step2.R -s sim1 -a all -f 1G_3000n_100causal_500000m -n $input_value

time Rscript saige_step1.R -s sim1 -a sex -f 1G_3000n_100causal_500000m_male -n $input_value
time Rscript saige_step2.R -s sim1 -a sex -f 1G_3000n_100causal_500000m_male -n $input_value

time Rscript saige_step1.R -s sim1 -a sex -f 1G_3000n_100causal_500000m_female -n $input_value
time Rscript saige_step2.R -s sim1 -a sex -f 1G_3000n_100causal_500000m_female -n $input_value
