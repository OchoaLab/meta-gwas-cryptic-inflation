...
if (sex == "male") {
  ...
  GMMATmodelFile = paste0(dir, trait, '_quant_male_age_loco.rda') 
  varianceRatioFile = paste0(dir, trait, "_quant_male_age_loco.varianceRatio.txt") 
  SAIGEOutputFile = paste0(dir, "saige_output_", trait, "_male_trait_age_loco_chr", chrom, ".txt") 
} else {
  plinkFile = "/home/tt207/pro00108518/t2d-samafs/study2/exome_chip/gwas_qc/exome_chip_qc_female"
  GMMATmodelFile = paste0(dir, trait, '_quant_female_age_loco.rda') 
  varianceRatioFile = paste0(dir, trait, "_quant_female_age_loco.varianceRatio.txt") 
  SAIGEOutputFile = paste0(dir, "saige_output_", trait, "_female_trait_age_loco_chr", chrom, ".txt") 
}
